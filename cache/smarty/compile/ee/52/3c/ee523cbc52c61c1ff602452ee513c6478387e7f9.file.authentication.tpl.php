<?php /* Smarty version Smarty-3.1.19, created on 2015-11-21 15:11:44
         compiled from "/Users/Lubko/Documents/Local/dogs/themes/socialdog/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:149707082756507ba0d3b304-01706202%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ee523cbc52c61c1ff602452ee513c6478387e7f9' => 
    array (
      0 => '/Users/Lubko/Documents/Local/dogs/themes/socialdog/authentication.tpl',
      1 => 1448113352,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '149707082756507ba0d3b304-01706202',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56507ba1acf418_89171557',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56507ba1acf418_89171557')) {function content_56507ba1acf418_89171557($_smarty_tpl) {?>
...
" method="post" id="login_form" >
				<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Already registered? Sign in to your account'),$_smarty_tpl);?>
</h3>
...
<?php }?>" placeholder="<?php echo smartyTranslate(array('s'=>'Email'),$_smarty_tpl);?>
" />
					
					<input class="is_required validate account_input form-control" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="" placeholder="<?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
" />
					
					<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
					<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-dog-login form-control">
						<span>
...
" method="post" id="account-creation_form" class="std box">
 ...
 <!-- @PODI - actually this hook is empty -->
		<div class="account_creation">
			<h3 class="page-subheading"><?php echo smartyTranslate(array('s'=>'Welcome aboard'),$_smarty_tpl);?>
</h3> 
			<!-- 1. column - registration data form-->
			<div class="col-xs-4">
...
$_smarty_tpl->tpl_vars['gender']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['gender']->key;
?>
						<div class="radio-inline"><?php echo $_smarty_tpl->tpl_vars['gender']->value->name;?>
</label>
							<label for="id_gender<?php echo $_smarty_tpl->tpl_vars['gender']->value->id;?>
" class="top">
							<input type="radio" name="id_gender" id="id_gender<?php echo $_smarty_tpl->tpl_vars['gender']->value->id;?>
...
<?php }?>" />
 ...
 <sup>*</sup></label>
			...
			<!-- 2. column - registration data form -->
			<div class="col-xs-4">
				<div class="form-group">
					<label><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
</label>
